# nvim-treesitter-queries-luau

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-luau/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-luau/actions/workflows/validate.yml)

Neovim tree-sitter queries for **luau**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-luau",
...
- [ ] Changes are scoped to `luau` — do not include files for other languages
